...
public class Customer {
    ...
    public static Iterator<Map<String, Object>> loginFeeder = Stream.generate(
    ...
    public static ChainBuilder login =  feed(loginFeeder)
        .exec(
            http("Login User")
                    .post("/login")
    ...
    public static ChainBuilder logout = randomSwitch().on(
